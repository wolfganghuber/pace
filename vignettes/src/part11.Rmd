...
```{r}
lpdCLL = lpdAll[ , lpdAll$Diagnosis=="CLL"]
lpdCLL = pace:::prepareLPD(lpd=lpdCLL, minNumSamplesPerGroup=5)
(predictorList = pace:::makeListOfPredictors(lpdCLL))
```
...
```{r}
predvar = unlist(pace:::makePredictions(drs=drs,
                                 lpd=lpdCLL,
...
Plot the legends.
```{r}
legends = pace:::makeLegends(legendFor=c("G","I","M", "P"))
```
...
predvar_rot = unlist(pace:::makePredictions(drs=drs_rot,
                                 lpd=lpdCLL,
                                 predictorList=predictorList,
...
```{r, eval=TRUE}
predvar2 = pace:::makePredictions(drs=drs,
                                        lpd=lpdCLL,
                                        predictorList=predictorList,
                                        lim=0.23)
```
